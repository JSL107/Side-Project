        ...
        <div class="innercon">
            ...
            <section>
                ...
                <h3>
                    ...
                    <strong style="color:;font-weight:bold">투홈 전체상품</strong>
                    <small style="color:;font-weight:normal">현대식품관의 모든상품</small></h3>
                    <!-- filter// -->
			                ...
			                <div class="filter-wrapper">
				                <div class="form-filter">
				                    ...
				                    <ul class="btn-group" id="sortType" onchange="fnAddItemList('N');">
				                        <li><button type="button"  onclick="location='TohomeServlet?command=all_productList&top_num=0&filter=3'">신상품순</button></li>
				                        <li><button type="button"  onclick="location='TohomeServlet?command=all_productList&top_num=0&filter=1'">낮은가격순</button></li>
				                        <li><button type="button"  onclick="location='TohomeServlet?command=all_productList&top_num=0&filter=2'">높은가격순</button></li>
				                    </ul>
				                </div>
				            </div>
				        </section>
                ...
                <c:forEach items="${bestProductList}"  var="productDTO">
			      <li class="pro">
                        <%--상품 상세 페이지와 연결 해주기--%>
