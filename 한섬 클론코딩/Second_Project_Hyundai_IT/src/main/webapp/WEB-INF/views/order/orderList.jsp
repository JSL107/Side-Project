            ...
            <div class="orderwrap del_pay">
                                ...
                                <td>
                                    ...
                                    <div id="price_wrap" class="price_wrap ">
                                        <span id="price" style="display: block" >
                                            <fmt:formatNumber value="${orderinfo.pprice}" pattern="\###,###,###,###"/></span>
                                        <del id="price_sale" style="display: none">
                                        <fmt:formatNumber
                                                value="${totalPrice}" type="number" pattern="\###,###,###,###"/></del>
                                    </div> <!-- //price_wrap -->
                ...
                <div class="float_right" style="position: absolute; left: 680px; top: 0px;">
                    ...
                    <div class="sum_box">
                        <div>
                            ...
                            <dl class="clearfix">
                                ...
                                <dd class="sub_total190816" id="subTotal">
                                    <fmt:formatNumber value="${orderTotal}" pattern="\###,###,###,###"/></dd>
                                <dt>프로모션/쿠폰 할인 금액</dt>
                        ...
                        <div class="total">
                            <dl class="clearfix">
                                ...
                                <dd>
                                    <input name = "odiscounted" id="sumPrice" value="${orderTotal}" readonly size=10
                    ...
                    <div class="p_a_box">
                        ...
                        <script>
                        var calculatePoint = ${orderTotal} * 0.05;
...
<script type="text/javascript">
    ...
    /* var couponCalculatePrice = ${totalPrice}-(${totalPrice} * ${orderinfo.saleprice});
    var calculatePrice =${totalPrice} *${orderinfo.saleprice}; */
...
<script>
    var calculatePoint =${totalPrice} * 0.05;
    $('#txtAccumulationHPointInput').val(calculatePoint);
</script>
