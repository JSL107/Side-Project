							...
							<div class="item_box">
								<a href="#" class="item_info1">
									...
									<span class="item_size" id="itemsize_0" style="display: none; height: 20px; padding-top: 15px; margin-top: 0px; padding-bottom: 15px; margin-bottom: 0px;">
										<div>
											<!-- 한 상품당 사이즈가 여러개 있을 수 있으므로, 상위 foreach문에서 사용한 index로  한 상품의 여러 사이즈를 받아옴 -->
								...
								<div class="color_more_wrap">
									<!-- 한 상품당 색상이 여러개 있을 수 있으므로, 상위 foreach문에서 사용한 index로  한 상품의 여러 색상을 받아옴 -->
									<c:forEach items="${colorMap[status.index] }" var="colorList" varStatus="status2">
										<a class="cl wt" style="background: url('${colorList.ccolorimage }');" productid="${product.pid }" ccolorcode="${colorList.ccolorcode }" ; cimage1="${colorList.cimage1}" cimage2="${colorList.cimage2}"></a>
