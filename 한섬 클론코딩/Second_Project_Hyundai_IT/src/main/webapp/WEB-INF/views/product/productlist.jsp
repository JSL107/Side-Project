	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			for (i = 0; i < products.length; i++) {
				var img1 = products[i].getElementsByClassName("cl")[0]
					.getAttribute("cimage3");
				var img2 = products[i].getElementsByClassName("cl")[0]
				...
				products[i].getElementsByClassName("respon_image")[1].setAttribute(
					"src", img2);
				// 김나형 상품디테일 href 설정 
				var productid = products[i].getElementsByClassName("cl")[0]
					.getAttribute("productid");
				var ccolorcode = products[i].getElementsByClassName("cl")[0]
