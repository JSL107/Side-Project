...
<meta charset="UTF-8">
<title>회원가입</title>
<link rel="stylesheet" href="${path}/resources/css/member/joinstart.css">
				...
				<div class="sub_container">
					...
					<fieldset>
						...
						<div class="box_type_1"
							style="margin-left: 1px; border: solid #ffffff; border-left-width: 270px; width: 530px;">
							<p>
							...
							<div class="mail_input_box">
								<input class="mail_input" name="memail" placeholder="이메일을 입력해주세요." style="font-size: 15px;"> 
								<div class="mail_check_wrap">
									...
									<input type="button" class="btn wt join_button" value="인증완료">
