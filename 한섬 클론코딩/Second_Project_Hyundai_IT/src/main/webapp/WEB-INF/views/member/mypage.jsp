        ...
        <div class="sub_cnts">
                ...
                <div class="pointbox_cover">
                    <div class="point">
                        ...
                        <a class="count"
                           ...
                           target="_blank"
                           onclick="GA_Event('마이페이지','회원정보','H.POINT');">${member.mpoint}&nbsp;<span>P</span></a>
                    </div>
                    <div class="point">
            ...
            <div class="tblwrap lncl1812">
                ...
                <table class="tbl_ltype review_betterment1905">
                    ...
                    <tr>
                        <td scope="col">${orderview.oid}<!-- 주문번호 --></td>
                        <td scope="col">
                            <img src="${orderview.cimage1}"
                                 style=height: 119px; width: 162.113;"> <!-- 상품정보 --></td>
                        <td scope="col" style="width: 125px;">${orderview.pname}<!-- 상품정보 --></td>
                        <td scope="col" style="padding: 15px 0">
                            ${orderview.oamount}<!-- 수량 --></td>
                        <!-- 스타일추가 181204 -->
                        <td scope="col">${orderview.pprice}<!-- 판매가 --></td>
                        <td scope="col">${orderview.ostatus}<!-- 주문상태 --></td>
                        <td scope="col">${orderview.clarge}<!-- 구분 --></td>
                    </tr>
                    </c:forEach>
                    </tbody>
