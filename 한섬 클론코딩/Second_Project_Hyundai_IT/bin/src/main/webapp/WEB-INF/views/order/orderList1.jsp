...
<div id="bodyWrap">
    ...
    <form id="orderForm" action="/order/ordering" method="post">
        ...
        <input type="hidden" id="ccolorcode" name="ccolorcode" value="">
        <input type="hidden" id="ssize" name="ssize" value="">
        <input type="hidden" id="pid" name="pid" value="">
        <input type="hidden" id="mid" name="mid" value="">
        <input type="hidden" id="oamount" name="oamount" value="">
        ...
        <div class="sub_container">
            ...
            <div class="orderwrap del_pay">
                    ...
                    <div class="tblwrap" id="deliveryInfoTitle">
                        <table class="tbl_wtype1">
                            ...
                            <tr>
                                ...
                                <td><!-- address -->
                                    <input value="" title="우편번호" id="address" name="ozipcode" class="post" type="text"
                                           readonly="">
                            ...
                            <tr>
                                ...
                                <td><input value="" title="수령인" id="rcpt_name" name="oreceiver" maxlength="13"
                ...
                <div class="float_right" style="position: absolute; left: 680px; top: 0px;">
                    ...
                    <!--//point & agreement box-->
                    <span id="doOrderBtn">
							<a href="#;" class="btn gray " onclick="chk_form();">결제하기</a>
                        </span>
                </div>
                <!--//orderwrap right-->
            </div>
