							...
							<div class="item_box">
								...
								<div class="color_more_wrap">
									<c:forEach items="${colorMap[status.index] }" var="colorList" varStatus="status2">
										<a class="cl wt" style="url('${colorList.ccolorimage }');" productid="${product.pid }" ccolorcode="${colorList.ccolorcode }" ; cimage1="${colorList.cimage1}" cimage2="${colorList.cimage2}"></a>
