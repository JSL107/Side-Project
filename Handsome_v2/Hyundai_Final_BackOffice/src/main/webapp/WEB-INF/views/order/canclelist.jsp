	...
	<div class="right_col" role="main">
            <!-- top tiles -->
				...
				<div class="title_left" style="
    				 ...
    				 padding-bottom: 20;">
                <h3>결제 환불관리</h3>
                <h5>고객의 주문 내역과 결제 취소를 할 수 있습니다.</h5>
                <h5>${orderstatus }</h5>
              	</div>
					...
					<div class="content bottom">
						...
						<table id="datatable" 
					        ...
					        <tr>
											...
											<th scope="col" style="padding:11px 0;color:#222;font-size:11px;font-family:'MalgunSemilight',sans-serif;text-align:center;background:#eae9e9;font-size:12px">결제 취소</th>
					        </tr>
					      </thead>
					      <tbody>
					      												<c:forEach items="${orderlist }" var="orderVO" varStatus="status">
											<c:if test="${orderVO.ostatus==3 }">
												<tr style="font-size:11px;text-align:center">
													...
													<input type ="hidden" id="imp_uid_${status.index }" value="${orderVO.imp_uid }"/>
													<td style="padding:15px;color:#222;border-left:1px solid #e5e5e5;border-bottom:1px solid #e5e5e5;font-family:'MalgunSemilight',sans-serif;font-size:12px">
													<a href="javascript:orderCancle(${status.index });" id="orderCancelBtn">결제 취소</a></td>
												</tr>
											</c:if>																					
										</c:forEach>		
					      </tbody>
