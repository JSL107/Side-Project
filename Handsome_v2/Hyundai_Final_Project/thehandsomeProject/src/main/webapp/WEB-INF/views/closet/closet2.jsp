    ...
    <div class="adaptive_wrap">
      <div class="evt_wrap">
        ...
        <div class="evt_main_ban type1" style="text-align: center; background-color: rgb(245,245,245)">
          <p>
            <img style="margin: auto; width: 100%" src="../../../resources/images/closet/closet_main.png" >
          </p>
            <div class="bxslider">
          ...
          <div style="padding-top: 115px; padding-bottom: 150px; font-family: Georgia">
          ...
          <form class="closet_img_form" id="closet_img_form" method="post" action="http://localhost:8080/closet/closet_result">
