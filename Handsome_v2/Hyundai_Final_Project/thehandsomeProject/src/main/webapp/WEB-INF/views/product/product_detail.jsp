...
<div id="bodyWrap" class="item_detail">
            ...
            <div class="item_detail_info float_right" id="contentDiv"
                ...
                <div class="info">
                    <div class="info_sect">
                        ...
                        <c:choose>
                            <c:when test="${price != null}">
                                <p class="price">
                                    <span id="pricespan">₩${price}</span> <input
                                        type="hidden" id="productPrice" value="${price}">
                                </p>
                            </c:when>
                            <c:otherwise>
                                <p class="price">
                        ...
                        <div class="prod-detail-con-box">
                            <strong class="number-code">상품품번 :
                                <c:if test="${clarge == '뷰티'}"><span id="pcscode">${productVO.pid}</span></c:if>
                                <c:if test="${clarge != '뷰티'}"><span id="pcscode">${curColorCode}</span></c:if>
                                <!-- 처음 로드될때 jqery로  --></span></strong>
                        ...
                        <ul class="color_size_qty">
                            <c:if test = "${clarge != '뷰티'}">
                                <li><span class="title">색상</span>
                                    ...
                                    </div> <span class="cl_name" id="colorNameContent"></span></li></c:if>
                            <c:if test="${clarge == '뷰티'}">
                                <input type="hidden" id="colorName" value="none">
                            </c:if>
                            ...
                            <li>
                                ...
                                <c:otherwise>
                                <span class="title">수량</span> <span class="txt">
                    ...
                    <div class="btnwrap clearfix"
                        ...
                        <form id="addToCartBuynowForm" name="addToCartBuynowForm" action="/order/order_page"
                              method="post">
                            <c:choose>
                                <c:when test="${price != null}">
                                    ...
                                    <input type="button" value="바로주문" class="btn order float_right mr0"
                    ...
                    <dl class="toggle_type1" style="margin-top: 80px;">
                        ...
                        <dd style="display: none;">
                            ...
                            ${productVO.p_madedate}<br> <c:if test="${clarge != '뷰티'}"><strong>세탁방법 및 취급 시
                            주의사항</strong>
                            ...
                            연락주시면 수선/교환/환불이 가능하나, 타업체(일반 수선실 등)에서 수선했을 경우는 불가능합니다.<br> <br></c:if>
                ...
                <div class="clearfix mt30">
                    <div class="btnwrap float_left">
                        <a href="javascript:fn_popupProductQnA();" class="btn arrow mr0" r>Q&amp;A(<span
                                class="data" id="productQnACnt">${qnacount }</span>)
                        </a>
                    </div>
    ...
    <div class="popwrap w_type_4" id="customerReviewDiv"
        ...
        <div class="pop_cnt evaluation_list1807 options">
            <div class="tab_a m3 mt20" style="border-bottom: 1px solid #d3d3d3;">
                        ...
                        <li class="evaluation_view" id="evaluation_view${reviewStatus.index}}">
                            ...
                            <div class="member_info_bottom">
                                <ul>
                                    ...
                                    <li class="must">• 구매 정보 : <span>${review.cname}</span> / <span>${review.ssize}</span>
                                        / <span>더한섬닷컴</span>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="clearfix">
                <table class="pop_tbl_ltype1">
                    ...
                    <c:forEach items="${qnalist }" var="qna" varStatus="status">
                        <tr>
                            <td scope="row"><c:out value="${qnacount - status.index }"/></td>
                            <td>
                                <c:choose>
                                    <c:when test="${qna.qsecret=='Y'}">
                                        <span class="ico_secret">비밀글</span>
                                        <c:choose>
                                            <c:when test="${member==qna.mid}">
                                                <a href="javascript:qnaDetail(${status.index });">${qna.qtitle }</a>
                                                <span class="answer_ready">${qna.qstate }</span>
                                            </c:when>
                                            <c:otherwise>
                                                <a>${qna.qtitle }</a>
                                                <span class="answer_ready">${qna.qstate }</span>
                        ...
                        <tr style="display: none;" id="qnaDetail_${status.index }" name="qnaDetail">
                            <td colspan="4" class="evaluation_view">
                                <p class="txt">${qna.qcontent }</p>
                                <div class="deledit_wrap">
                                    <c:if test="${member eq qna.mid}">
                                    	<c:if test="${qna.qstate == '답변대기중' }">
                                    		<a href="javascript:fn_popupProductQnAModify(${qna.qno })">수정</a>
                                    	</c:if>                                        
                                        <a href="javascript:productDeleteQna(${qna.qno })">삭제</a>
                                    </c:if>

                                </div>
                                <c:if test="${qna.qreplycontent != null }">
                                    <div class="answer_wrap" id="answer_wrqp_${qna.qno }">
                                            ${qna.qreplycontent }
                                    </div>
                                </c:if>
                            </td>
                                ...
                                <td>
                                    <div style="position: relative;">
                                        ...
                                        <input type="text" id="inquiryMobileNo2"
                                               ...
                                               style="width: 80px;" maxlength="4" value="${mtel2 }">
                                        <div class="form_hyphen">-</div>
                                        <input type="text" id="inquiryMobileNo3"
                                               name="inquiryMobileNo3" title="휴대폰 번호 뒷자리"
                                               style="width: 80px;" maxlength="4" value="${mtel3 }"> <span
                                            ...
                                            style="display: block; position: absolute; top: 3px; right: 14px;">
												<input type="hidden" id="smsNoticeYN" name="smsNoticeYN"
                                                       value="N"> <input type="checkbox"
                                                                         ...
                                                                         style="margin-top: 1px;" value="N"> <label
                            ...
                            <tr>
                                ...
                                <td><input type="hidden" id="replyToEmail"
                                           name="replyToEmail"> <input type="text"
                                                                       ...
                                                                       title="이메일아이디" style="width: 120px;" value="${memail1 }"> <span
                                        class="andmail">@</span> <input type="text"
                                                                        id="inquiryEmailDomain" name="inquiryEmailDomain"
                                                                        title="이메일계정 입력란" style="width: 120px;" value="${memail2 }"> <select
                                        id="inquiryEmailSel" title="이메일계정" onchange="clearemailDomain();"
                    ...
                    <p class="guide_txt clearfix" style="border-top: 0;">
						<span class="float_left"><strong>상품에 관한 배송, 교환, 취소
							...
							<input type="checkbox" name="securitySentenceYn"
                                   id="securitySentenceYn" value="N" checked><label
                            for="securitySentenceYn">비밀글 설정</label>
						</span>
                    </p>
                    <div class="btnwrap mt40">
                        <input type="button" id="qnaCancle" value="취소하기" class="btn wt">
                        <input type="button" id="qnaWriteSend" value="등록하기" onclick="qnaWrite();"
                               class="btn gray mr0">
                    </div>
                </fieldset>
                <div>
...
<div class="layerArea" id="productLayer" style="display: none;">
    ...
    <div class="popwrap w_type_1 " id="Order_confirm" style="position: fixed; top: 30%; left: 50%; display:none;"
         tabindex="-1">
        <div class="pop_cnt">
    ...
    <div
            ...
            style="position: fixed; top: 30%; left: 50%; display:none;"
            tabindex="-1"
    >
        <div class="pop_cnt">
...
<div class="popwrap w_type_3" id="productQnAModifyDiv"
     style="display: none;">
    <div class="pop_tltwrap2">
        <h3>상품문의하기</h3>
    </div>
            ...
            <fieldset>
                ...
                <div class="tblwrap">
                    ...
                    <table class="tbl_wtype1">
                        ...
                        <tr>
                            <th scope="row"><strong class="reqd">*</strong><label
                                    for="inquiryTitle_modify">문의제목</label></th>
                            <td><input type="text" id="inquiryTitle_modify"
                                       name="inquiryTitle_modify" title="input" style="width: 100%">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><strong class="reqd">*</strong><label
                                    for="inquiryContents_modify">문의내용</label><span class="com_txt_p">(300자
										이하)</span></th>
                            <td><textarea name="inquiryContents_modify" id="inquiryContents_modify"
                                          cols="30" rows="5" style="width: 98%; height: 200px"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row" class="th_space"><label
                                    for="inquiryMobileNo2_modify">SMS 알림받기</label></th>
                            <td>
                                <div style="position: relative;">
                                    <input type="hidden" id="smsMobileNo" name="smsMobileNo">
                                    <select id="inquiryMobileNo1_modify" title="휴대폰 번호 앞자리"
                                            style="width: 80px; margin-top: 0; vertical-align: middle; padding: 3px 8px 3px 8px;">
                                        <c:choose>
                                            <c:when test="${mtel1 eq 010 }">
                                                <option value="010" selected="selected">010</option>
                                    ...
                                    <div class="form_hyphen">-</div>
                                    <input type="text" id="inquiryMobileNo2_modify"
                                           name="inquiryMobileNo2_modify" title="휴대폰 번호 가운데자리"
                                           style="width: 80px;" maxlength="4" value="${mtel2 }">
                                    <div class="form_hyphen">-</div>
                                    <input type="text" id="inquiryMobileNo3_modify"
                                           name="inquiryMobileNo3_modify" title="휴대폰 번호 뒷자리"
                                           style="width: 80px;" maxlength="4" value="${mtel3 }"> <span
                                        class="sms_alm_2006_chk"
                                        style="display: block; position: absolute; top: 3px; right: 14px;">
											<input type="hidden" id="smsNoticeYN" name="smsNoticeYN"
                                                   value="N"> <input type="checkbox"
                                                                     id="inquirySmsNoticeYn_modify" name="inquirySmsNoticeYn_modify"
                                                                     style="margin-top: 1px;" value="N"> <label
                                        for="inquirySmsNoticeYn_modify">SMS 알람고지</label>
										</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="inquiryEmailAddress_modify"><strong
                                    class="reqd">*</strong><label for="inquiryMobileNo2_modify">이메일
                                답변받기</label></label></th>
                            <td><input type="hidden" id="replyToEmail_modify"
                                       name="replyToEmail_modify"> <input type="text"
                                                                          id="inquiryEmailAddress_modify" name="inquiryEmailAddress_modify"
                                                                          title="이메일아이디" style="width: 120px;" value="${memail1 }"> <span
                                    class="andmail">@</span> <input type="text"
                                                                    id="inquiryEmailDomain_modify" name="inquiryEmailDomain_modify"
                                                                    title="이메일계정 입력란" style="width: 120px;" value="${memail2 }"> <select
                                    id="inquiryEmailSel_modify" title="이메일계정"
                                    style="width: 140px; padding: 3px 8px 3px 8px;">
                                <option value="" selected="selected">직접입력</option>
                                <option value="naver.com">naver.com</option>
                                <option value="daum.net">daum.net</option>
                ...
                <p class="guide_txt clearfix" style="border-top: 0;">
					<span class="float_left"><strong>상품에 관한 배송, 교환, 취소
							등의 자세한 문의사항은 고객센터를 이용해 주시기 바랍니다.</strong></span> <span class="float_right">
						<input type="checkbox" name="securitySentenceYn_modify"
                               id="securitySentenceYn_modify" value="N" checked><label
                        for="securitySentenceYn_modify">비밀글 설정</label>
					</span>
                </p>
                <div class="btnwrap mt40">
                    <input type="button" id="qnaModifyCancle" value="취소하기" class="btn wt">
                    <input type="button" id="qnaModifySend" value="수정하기" onclick="qnaModify();"
                           class="btn gray mr0">
                </div>
            </fieldset>
            <div>
...
<div class="layerArea2" id="qnaLayer" style="z-index:1110; display:none">
    <div class="layerBg">
    </div>
    <div class="popwrap w_type_1" id="AskDelete" style="z-index: 150; margin-top: 1150.5px;" tabindex="-1">
        <div class="pop_cnt">
            <h3 class="pop_tlt copy">삭제 하시겠습니까?</h3>
            <div class="btnwrap">
                <input type="button" id="clsqna" class="btn wt_s mr5" onclick="fn_closeQnA();" value="취소" >
                <input type="button" id="cfBtn" class="btn gray_s mr0" onclick="qnaDelete()" value="확인">
            </div>
        </div>
        <a href="javascript:void(0);" class="btn_close2">
        </a>
    </div>
</div>


<div class="layerArea2" id="qnaLayer2" style="z-index:1110; display:none">
    <div class="layerBg">
        <div class="popwrap w_type_1" id="AskCancle" style="z-index: 150; margin-top: 300.5px;" tabindex="-1">
            <div class="pop_cnt">
                <h3 class="pop_tlt copy">취소 하시겠습니까?</h3>
                <div class="btnwrap"><input type="button" id="clsqna" class="btn wt_s mr5" onclick="fn_closeQnA();" value="취소" >
                    <input type="button" id="cfBtn" class="btn gray_s mr0" onclick="askCancleConfirm()" value="확인">
                </div>
            </div>
            <a href="javascript:void(0);" class="btn_close2">
            </a>
...
<script>
	...
	function qnaDetail(index){
		//펼쳐저 있으면 닫기
		if($("#qnaDetail_"+index).css("display")=="none"){
			$("#qnaDetail_"+index).show();
		}
		//닫혀 있으면 펼치기
		else{
			$("#qnaDetail_"+index).hide();
		}
		
	}
	function clearemailDomain(){
		$('#inquiryEmailDomain').val($('#inquiryEmailSel').val());
	}
	function qnaWrite(){
		let qtitle = $('#inquiryTitle').val();
		let qcontent = $('#inquiryContents').val();
		let mobileno1 = $('#inquiryMobileNo1').val();
		let mobileno2 = $('#inquiryMobileNo2').val();
		let mobileno3 = $('#inquiryMobileNo3').val();
		let smsNotice = $('#inquirySmsNoticeYn').val();
		if($('#inquirySmsNoticeYn').is(':checked')){
			smsNotice = 'Y';
		}
		let emailReply = $('#replyToEmail').val();
		let emailAdress = $('#inquiryEmailAddress').val();
		let emailDomain = $('#inquiryEmailDomain').val();
		let emailSel = $('#inquiryEmailSel').val();
		if(emailSel==""){
			emailSel = emailDomain;
		}
		let security = $('#securitySentenceYn').val();
		if($('#securitySentenceYn').is(':checked')){
			security = 'Y';
		}
		
		let phnum = mobileno1+mobileno2+mobileno3;
		let qemail = emailAdress+"@"+emailSel;
		...
		$.ajax({
			...
			data : JSON.stringify(qnaparam), //직렬화
			//dataType : 'text',
	...
	function qnaModify(){
		console.log("수정 클릭");
		let qtitle_modify = $('#inquiryTitle_modify').val();
		let qcontent_modify = $('#inquiryContents_modify').val();
		let mobileno1_modify = $('#inquiryMobileNo1_modify').val();
		let mobileno2_modify = $('#inquiryMobileNo2_modify').val();
		let mobileno3_modify = $('#inquiryMobileNo3_modify').val();
		let smsNotice_modify = $('#inquirySmsNoticeYn_modify').val();
		let qno = $('#qno').val();
		if($('#inquirySmsNoticeYn_modify').is(':checked')){
			smsNotice_modify = 'Y';
		}
		let emailReply_modify = $('#replyToEmail_modify').val();
		let emailAdress_modify = $('#inquiryEmailAddress_modify').val();
		let emailDomain_modify = $('#inquiryEmailDomain_modify').val();
		let emailSel_modify = $('#inquiryEmailSel_modify').val();
		if(emailSel_modify=="직접입력"){
			emailSel_modify = emailDomain_modify;
		}
		let security_modify = $('#securitySentenceYn_modify').val();
		if($('#securitySentenceYn_modify').is(':checked')){
			security_modify = 'Y';
		}
		
		let phnum_modify = mobileno1_modify+mobileno2_modify+mobileno3_modify;
		let qemail_modify = emailAdress_modify+"@"+emailSel_modify;
		
		let mname = "${mname}";
		console.log("qtitle : "+qtitle_modify);
		console.log("qcontent : "+qcontent_modify);
		console.log("mobileno1 : "+mobileno1_modify);
		console.log("mobileno2 : "+mobileno2_modify);
		console.log("mobileno3 : "+mobileno3_modify);
		console.log("smsNotice : "+smsNotice_modify);
		console.log("emailAdress : "+emailAdress_modify);
		console.log("emailSel : "+emailSel_modify);
		console.log("securty : "+security_modify);
		console.log("qno : "+ qno);
		const qnamodifyparam={
			qtitle : qtitle_modify,
			qcontent : qcontent_modify,
			qsecret : security_modify,
			qsmssend : smsNotice_modify,
			qphonenum : phnum_modify,
			qemail : qemail_modify,
			qno : qno
		};
		//csrf토큰
		let csrfHeaderName ="${_csrf.headerName}";
		...
		$.ajax({
			url : '/qna/questionmodify',
			type : 'POST',
			beforeSend: function(xhr) { xhr.setRequestHeader(csrfHeaderName, csrfTokenValue);},
			data : JSON.stringify(qnamodifyparam), //직렬화
			//dataType : 'text',
			contentType : 'application/json; charset=utf-8',
			success : function(result) {
				Swal.fire({
	...
	function qnaDelete(){
		...
		let csrfTokenValue="${_csrf.token}";
		$.ajax({
			url : '/qna/questiondelete',
			type : 'POST',
			beforeSend: function(xhr) { xhr.setRequestHeader(csrfHeaderName, csrfTokenValue);},
			data : JSON.stringify(qnadeleteparam), //직렬화
			//dataType : 'text',
			contentType : 'application/json; charset=utf-8',
			success : function(result) {
				Swal.fire({
	...
	function reviewRowInsert(p){
		...
		$.ajax({
			...
			success : function(result) {
				...
				$("customerReviewCnt").text(result.reviewinfo[0]);//detail페이지에서 상품평 변경 
				$("#review_cnt").text(result.reviewinfo[0])//갯수
				$("#totalStarScore").removeClass("star1","star2","star3","star4","star5")//별점 초기화
				...
				list.forEach((value, index, array) => {
					...
					let maskingName = "";
					if (value.mid.length === 2) {
						maskingName = value.mid.replace(/(?<=.{1})./gi, '*');
				    } else if (value.mid.length > 2) {
				    	maskingName = value.mid.replace(/(?<=.{2})./gi, '*');
				    } else {
				    	maskingName = value.mid;
				    }

					//yyyy-mm-dd 날짜 변환
					let dateFormatted = toStringByFormatting(writeDate);
					$("#reviewRow").find(".name").text(maskingName);
					$("#reviewRow").find(".grade").text(value.mgrade);
					...
					$("#reviewRow").find("#row11").text("연령 : " + value.rcontentMap.age);
					$("#reviewRow").find("#row12").text("키 : " + value.rcontentMap.height+" cm");
					$("#reviewRow").find("#row13").text("체형 : " + value.rcontentMap.bodyType);
					$("#reviewRow").find("#row14").text(value.rcontentMap.enjoySize);
					
					$("#reviewRow").find("#row21").text(value.cname);
					$("#reviewRow").find("#row22").text(value.ssize);
	...
	function fn_reviewWriteSend() {
		Swal.fire({
    		...
    		let csrfHeaderName ="${_csrf.headerName}";
    		let csrfTokenValue="${_csrf.token}";
    		var order = $('input[name=reviewOrderId]').val();
    		var color = $('input[id=purchaseColor]').val();
	...
	function fn_reviewWriteCheck() {
		...
		$.ajax({
			...
			dataType : 'json',
			success : function(result) {
				//console.log("작성여부 체크 : " + result.pid + " , oid : "  + result.oid);
				//상품평 작성란을 띄운다.
				$("#customerReviewDiv").hide();
				viewPopup("#customerReviewWriteDiv");
				
				
				$('input[name=reviewOrderId]').val(result.oid);
				$('input[id=purchaseColor]').val(result.ccolorcode);
	...
	function fn_popupProductQnAModify(qno){
		//QnA 리스트를 숨긴다.
		$("#productQnADiv").hide();
		...
		let readqnaparams = {
			...
			$.ajax({
				url : "/qna/questionreadformodify",
				type : 'POST',
				beforeSend: function(xhr) {
			          xhr.setRequestHeader(csrfHeaderName, csrfTokenValue);},
				data : JSON.stringify(readqnaparams),// json 형태의 데이터
				contentType : 'application/json; charset=utf-8',
				success : function(result) {
					console.log(result);
					$('#inquiryTitle_modify').val(result.qtitle);
					$('#inquiryContents_modify').val(result.qcontent);
				},
...
//		}
    ...
    //QnA 수정 취소하기
    $("#qnaModifyCancle").on('click', function() {
        $("#qnaLayer2").show();
        $("#AskCancle").show();
        //취소를 원하면 QnA 작성란을 숨기고 상품 QnA 리스트를 보여줌
//		if (confirm("취소하시겠습니까?")) {
//			$("#productQnAModifyDiv").hide();
//			viewPopup("#productQnADiv");
//		}
    });
    function askCancleConfirm(){
        $('#qnaLayer2').hide();
        $("#AskCancle").hide();
        $("#productQnAWriteDiv").hide();
        $("#productQnAModifyDiv").hide();
    ...
    function addWishListClick() {
        ...
        itemMap.set('ssize', selectSize);
        itemMap.set('cname', selectColor);
        ...
        if (isWishList != "0") {//이미 등록된 상태 일때
            ...
            $.ajax({
                ...
                data: JSON.stringify(params),	// json 형태의 데이터
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    console.log("삽입성공");
                    isWishList = "1";
        ...
        function () {
            ...
            $(".sizeBtn").on(
                ...
                function (e) {
                    ...
                    selectSize = sizeText;
                    if (prev_colorcode === "none") {
                        $("#pcscode").text("${productVO.pid}");
                    } else {
            ...
            $("#addToCartButton").on("click", function (e) {
                ...
                if (selectSize === "") {
                    ...
                    if ("${member}" == "") {
                        ...
                        console.log(params);
                        console.log("선택 사이즈:" + selectSize);
                        console.log("선택 사이즈:" + selectColor);
                        //ajax 호출!
                        $.ajax({
                            ...
                            error: function (XMLHttpRequest, textStatus, errorThrown) { // 비동기 통신이 실패할경우 error 콜백으로 들어옴
                            	Swal.fire({
                                    text: '장바구니 담는데 실패했습니다.',
                                    icon: 'warning',
                                });
                            	//alert("통신 실패." + XMLHttpRequest + " d" + textStatus + " d" + errorThrown);
                            }
                        });
                    }
                }
            ...
            $("#addToCartBuyNowButton").on(
                ...
                function() {
                    ...
                    if (${price!=null}) {
                        $('#addToCartBuynowForm').find("input[name='orders[0].oamount']").val(1);
