...
public class ReviewServiceTests {
	...
	public void getReviewListWithPaging() throws Exception{
		...
		reviewservice.getReviewListWithPaging(pid, cri);
	}
	...
	public void getReviewCount() throws Exception{
		...
		String pcolor = "BK";
		String psize = "88";
		reviewservice.getReviewCount(pid, mid, pcolor, psize);
	}

	@Test
	public void UserReviewCount() throws Exception{
		String mid = "admin";
		reviewservice.UserReviewCount(mid);
	}
	...
	public void getReviewMemberList() throws Exception{
		String pid = "MN2C8WJC022WP2";
		String mid = "admin";
		reviewservice.getReviewMemberList(pid, mid);
	}
}
